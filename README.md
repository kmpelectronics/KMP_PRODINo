...
| `P720 - RAK3172 8AINv3.0 -Test` | SMARTI8 | Production test jig for a combined RAK3172 + 8AIN v3.0 board: PING/PONG RF test plus an 8-channel analog test (relay injects 3.3V, tolerance window, short-between-inputs detection); results on the two status LEDs |
...
| `Stamp-C3U-RS485-Echo` | M5Stamp C3U + PWR485 | RS485 echo tester (ESP32-C3): "ping" -> "pong", any other string echoed reversed ("1234" -> "4321"); WS2812 LED blinks green on RX / blue on TX. RX=G8, TX=G10 |
