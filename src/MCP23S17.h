...
#define    IOCON_    (0x15)      // Also Configuration Register if IOCON.BANK = 1
...
public:
	...
	uint16_t wordRead(uint8_t);               // Reads an individual register and returns the byte. Argument is the register address
